								...
								<li class="product-item">
									<div class="product product-widget-style">
										...
										<div class="product-info">
											...
											<div class="wrap-price"><span class="product-price">Rs.{{$p_product->regular_price}}</span></div>
										</div>
									</div>
								</li>
                                @endforeach
                                ...
                                @foreach($related_products as $r_product)
                                    <div class="product product-style-2 equal-elem ">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="wrap-price"><span class="product-price">Rs.{{$r_product->regular_price}}</span></div>
                                        </div>
                                    </div>
                                 @endforeach
